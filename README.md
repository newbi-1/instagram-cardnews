...
- [실행 방법](설명서_실행방법.md) — Windows Python 설치, 압축 해제, `run.bat`, 브라우저 4탭 사용
- [인스타 연결](설명서_인스타연결.md) — Meta 앱 / Instagram Login 토큰, `IG_USER_ID`, `.env`, 무료 이미지 업로드 경로
- [판매자용](설명서_판매자용.md) — 고객별 폴더, 콘셉트 팩, 공식 API만, 토큰·면책
